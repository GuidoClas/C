...
int getRandomInfectados()
{
    ...
    aleatorio = rand()%(2000000)+40000; //siempre se pone un numero mas grande del maximo que quiero.
...
int getRandomRecuperados()
{
    ...
    aleatorio = rand()%(1000001)+50000; //siempre se pone un numero mas grande del maximo que quiero.
    //siempre que se pide un valor con rand devuelve un valor distinto.
    return aleatorio;
}
...
int getRandomMuertos()
{
    ...
    aleatorio = rand()%(50000)+1000; //siempre se pone un numero mas grande del maximo que quiero.
    //siempre que se pide un valor con rand devuelve un valor distinto.
    return aleatorio;
}
