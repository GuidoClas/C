...
int main()
{
    ...
    eAuto autos [TAMAU] = {{1, "AAA111", 1001, 5000, 2015, 0},
                            ...
                            {5, "EEE555", 1001, 5000, 2013, 0}};

    eMarca marcas[TAMMA] = {{1000, "Renault",},{1001, "Fiat"}, {1002, "Ford"}, {1003, "Chevrolet"}, {1004, "Peugeot"}};
    eColor colores[TAMCO] = {{5000, "Negro"}, {5001, "Blanco"},{5002, "Gris"}, {5003, "Rojo"}, {5004, "Azul"}};
    ...
    do
    {
        ...
        case 9:
            ...
            break;
        case 10:
            informar(autos, trabajos, marcas, colores, servicios, TAMAU, TAMTRA, TAMMA, TAMCO, TAMSER);
            break;
        case 11:
            printf("\n Salida exitosa");
            break;
